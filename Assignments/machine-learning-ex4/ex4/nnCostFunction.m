...
for t=1:m
    ...
    % Step 2, for hidden layer l = 3
	delta_3 = a3 - y_new(:,t); % (10*1)
	
    z2=[1; z2]; % bias (26*1)
    
    
    % Step 3, for hiddel layer l = 2, set
    ...
    % Note that you should skip or remove δ 0 .
...
% Step 5 will divide the accumulated gradients by m to obtain 
% the gradients for the neural network cost function. from this we 
